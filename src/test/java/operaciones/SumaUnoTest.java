...
public class SumaTest {
	...
	public void NoventaYNuevaMasUno() {
		...
		assertTrue("Sumar 99 más uno no da 100", result.get(0) == 1 && result.get(1) == 0 && result.get(2) == 0);
	}
	...
	public void TrescientosQuinceMasUno() {
		...
		assertTrue("Sumar 315 más uno no da 316", result.get(0) == 3 && result.get(1) == 1 && result.get(2) == 6);
	}
